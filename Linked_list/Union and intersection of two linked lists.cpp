...
struct node
{
    int data;
    struct node*next;
}*head1=NULL,*head2=NULL,*temp=NULL,*res=NULL,*res1=NULL;
...
void unionl (struct node*head1, struct node*head2)
{
    int flag;                                   //if list 1 have duplicates, it also prints...
    struct node*temp1=head1,*temp2=head2;
    while(temp1!=NULL)
    {
        insertnode(&res1,temp1->data);
        temp1=temp1->next;
    }
    while(temp2!=NULL)
    {
